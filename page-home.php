...
?>
    ...
    <div class="container">
        <header class="codrops-header">
            ...
            <p>Web Developer from Minneapolis MN. I run Public Service Websites and also do a fair amount of free lance development work. Feel free to get in touch!</p>
