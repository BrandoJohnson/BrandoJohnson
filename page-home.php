...
?>
    ...
    <div class="container">
        <header class="codrops-header">
            ...
            <p>UI Designer from Minneapolis MN and creator of Public Service Websites. <br/> I also do a fair amount of freelance development work. Feel free to get in touch!</p>
